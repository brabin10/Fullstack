import com.exception.CheckedException;
import com.exception.UncheckedException;
...
public class Launcher {
	...
	public static void main(String[] args) {
		...
		//This code will compile,ArithmeticException is Runtime Exception, so the compiler isn't checking for it
		//System.out.println(i2/i);
		
		System.out.println("Trying to access an Array index that doesn't exit");
		int[] numbers = { 0, 1, 2};
		
		//This code will call index 3, but as we know this Array only has indexes 0-2
		//Thus, an ArrayIndexOutOfBoundException will be thrown
...
try { //try will TRY a block of code that may or may not throw an exception
	...
	System.out.println("Will I run? NO!!!! I'm only checking for UncheckedException");
	
} catch (CheckedException e) {
	
	System.out.println("Hello from the catch block - CheckedException was caught!!");
...
//Very common to see the final catch block catch just a generic Exception, as a safety precaution
	...
	//Creating methods that throw our custom exceptions-------------------------------------------------
		...
		public static void throwChecked() throws CheckedException {
			...
			throw new CheckedException("Our custom CHECKED exception was thrown"); 
		...
		public static void throwUnchecked()  {
			...
			throw new UncheckedException("Our custom UNCHECKED exception was thrown");
