...
public class MyThread extends Thread {
	...
	public void run() {
		...
		for (int i = 0; i < 10; i++) {
			...
			// we have to use StringBuffer, because StringBuilder isn't thread safe. The
			// only reason we'd use buffer > builder
			...
			// sleep() is a method that makes the thread wait some amount of milliseconds
			// between iterations
			try {
				Thread.sleep(500);
