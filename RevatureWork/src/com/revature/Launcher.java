...
public class Launcher {
	...
	public static void main(String[] args) {
		...
		// Instantiate a new Person object, using the no-args constructor (since we give
		// it no arguments)
		Person tyler = new Person();
		// Is this a reference variable or a primitive? Reference variable!! Because
		// it's REFERENCING an object
		...
		// Instantiate a new Person object, using the all-args constructor (since we
		// give it all arguments)
		...
		// Pirate extends Person, so Pirate has everything Person has, but not the other
		// way around
