...
public class UserController {
	...
	public Handler loginHandler = (ctx) -> {
		...
		if(us.login(LDTO.getUsername(), LDTO.getPassword()) != null) {
			...
			//here, we're using .toJson() to take in the result of our successful login (which is an Reimbursement object)
			String reimbursementJSON = gson.toJson(us.login(LDTO.getUsername(), LDTO.getPassword()));
